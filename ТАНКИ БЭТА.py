...
framepersecond = 32
pipeimage = 'pipes.png'
background_image = 'phone.jpg'
birdplayer_image = 'samo l.png'
...
if __name__ == "__main__": 
	...
	game_images['scoreimages'] = ('1', '2', '3', '4', '5', '6', '7', '8', '9', '0')
	game_images['samo l.png'] = pygame.image.load(birdplayer_image)
	game_images['phone.png'] = pygame.image.load(background_image)
	game_images['pipes.png'] = (pygame.transform.rotate(pygame.image.load(pipeimage).convert_alpha(), 180), pygame.image.load(pipeimage))
